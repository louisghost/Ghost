...
const scalarCodec = (config?: {field?: string}) => composeCodec(columnAddressing(config), scalarSemantics());
const numberCodec = (config?: {field?: string}) => composeCodec(columnAddressing(config), numberSemantics());
